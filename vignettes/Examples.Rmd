...
```{pikchr}
B1: box "Etapa 1" bold "Revisão Bibliográfica" wid 2 rad .1 #fill 0xA7C7E7
arrow
B2: box "Etapa 2" bold "Definição do Objeto de Estudo" wid 2 rad .1 #fill 0xB2E1B5
arrow right then down 1 then left rad .2 
B3: box "Etapa 3" bold "Coleta de Dados" wid 2 rad .1 #fill 0xFDFD96
arrow
B4: box "Etapa 4" bold "Análise de Dados" wid 2 rad .1 #fill 0xD4A5E3
arrow left then down 1 then right rad .2
B5: box "Etapa 5" bold "Propostas e Diretrizes" wid 2 rad .1 #fill 0xFBC4AB
arrow
B6: box "Etapa 6" bold "Validação das Diretrizes" wid 2 rad .1  #fill 0xF8C8DC
arrow right then down 1 then left until even with B6.c rad .2
B7: box "Etapa 7" bold "Apresentação dos Resultados" wid 2 rad .1 # fill 0xD3D3D3
